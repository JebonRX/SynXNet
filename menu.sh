...
echo -e "${white}SSH/OpenVPN = ${green}${total_ssh:-0}${white},  Trojan-TCP = ${green}${trtls:-0}${white},  Trojan-Go = ${green}${trgo:-0}${reset}"
...
echo -e " ${yellow}(2)${white} TROJAN TCP & GO             ${yellow}(9)${white}  CHECK RUNNING"
