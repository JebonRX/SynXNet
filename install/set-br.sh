...
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/JebonRX/SynXNet/main/rclone.conf"
...
cd /usr/bin
wget -O autobackup "https://raw.githubusercontent.com/JebonRX/SynXNet/main/system/autobackup.sh"
