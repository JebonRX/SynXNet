...
links3="sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/‎JebonRX/SynXNet/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh"
...
echo "  Script Ver    : nevermore_SynXNet"
echo -e "\033[0;34m----------------------------------------\033[0m"
...
clear
echo -e "\033[0;34m----------------------------------------\033[0m"
echo -e "\E[44;1;39m    MENU ADD IP SynXNet WS  \E[0m"
echo -e "\033[0;34m----------------------------------------\033[0m"
echo ""
...
echo -e ""
echo -e "\033[0;34m----------------------------------------\033[0m"
echo -e "\E[44;1;39m      SCRIPT SynXNet WS \E[0m"
echo -e "\033[0;34m----------------------------------------\033[0m"
echo ""
